...
/**
 * If you are not using rollup to build your ionic app, this configuration will
 * not affect your code, se webpack.config.js instead.
 */

const rollupConfig = require(
  '../node_modules/@ionic/app-scripts/config/rollup.config');
